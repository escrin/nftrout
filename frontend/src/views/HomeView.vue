      ...
      <section class="flex flex-col" v-if="!hidingIntro">
        ...
        <div class="p-5 blur-bg inline-block mx-auto">
          <p class="padded !mt-0">
            ...
            itself. Since nobody knows the genes, each trout is unpredictable and unique, just like
            a real trout.
          </p>
          <h3>How to Play</h3>
          <ol class="max-w-prose list-decimal text-left m-auto list-inside padded">
            ...
            >
            <li class="my-2"
              >The new trout will appear under "Owned Trout". Owned trout can be farmed for
              breeding, which brings in passive ROSE income. You can unfarm any time.</li
            >
          </ol>
          ...
          <ul class="max-w-prose list-disc text-left m-auto list-inside padded">
            <li class="my-2"
              ...
              <a href="https://twitter.com/EnshrineCC" target="_blank">Twitter</a>, or
            ...
            <li class="my-2"
              >There is and will forever be an 80 ROSE breeding fee that is paid to the Escrin
              network for trusted computation.</li
            >
